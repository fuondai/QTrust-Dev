...
class TestEnergySimulation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create a simulation instance with short parameters for faster testing
    ...
    def test_run_simulation(self):
        ...
        # Check that in general Adaptive PoS uses less energy
        # (it's possible but unlikely that in a small test it could use more)
        self.assertLessEqual(results["total_adaptive_energy"], results["total_standard_energy"] * 1.2)
    ...
    def test_plot_simulation_results(self):
        ...
        output_file = os.path.join(self.test_dir, "energy_optimization_results.png")
