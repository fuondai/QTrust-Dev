...
"""
HTDCM Testing Module for Advanced Malicious Node Detection

This module tests the HTDCM (Hierarchical Trust-based Data Center Mechanism) 
capability to detect malicious nodes in a blockchain network.
"""
...
def test_htdcm_malicious_detection():
    ...
    plt.tight_layout()
    chart_path = get_chart_path('htdcm_test_results.png', 'test')
